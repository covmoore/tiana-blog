        ...
        <form>
            <div class="w-full mb-4 border border-default-medium rounded-base bg-neutral-secondary-medium shadow-xs">
                ...
                <div class="px-4 py-2 bg-neutral-secondary-medium rounded-b-base">
                    ...
                    <textarea id="editor" rows="8" class="block w-full py-2 px-4 text-sm text-heading bg-neutral-secondary-medium border-0 focus:ring-0 placeholder:text-body" placeholder="Create your post..." required ></textarea>
                </div>
            </div>
